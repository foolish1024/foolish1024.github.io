!function(r) {
    ...
    function g(r) {
        ...
        if (!t)
            return null;
        var n, o, i = r.size, a = r.background, u = Math.floor, f = t.moduleCount, c = u(i / f), l = u(.5 * (i - c * f)), s = {
            position: "relative",
            left: 0,
            top: 0,
            padding: 0,
        ...
        for (a && h.css("background-color", a),
        n = 0; f > n; n += 1)
            for (o = 0; f > o; o += 1)
                t.isDark(n, o) && w("<div/>").css(d).css({
                    left: l + o * c,
                    top: l + n * c
                }).appendTo(h);
        return h
    ...
    var r = function() {
            ...
            var o = 236
              ...
              , T = function(r, t) {
                for (var e = -1; 7 >= e; e += 1)
                    if (!(-1 >= r + e || r + e >= h))
                        for (var n = -1; 7 >= n; n += 1)
                            -1 >= t + n || t + n >= h || (e >= 0 && 6 >= e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n ? d[r + e][t + n] = !0 : d[r + e][t + n] = !1)
            }
              , y = function() {
                ...
                for (var r = i.getPatternPosition(l), t = 0; t < r.length; t += 1)
                    for (var e = 0; e < r.length; e += 1) {
                        ...
                        if (null == d[n][o])
                            for (var a = -2; 2 >= a; a += 1)
                                for (var u = -2; 2 >= u; u += 1)
                                    -2 == a || 2 == a || -2 == u || 2 == u || 0 == a && 0 == u ? d[n + a][o + u] = !0 : d[n + a][o + u] = !1
                    }
            }
              , B = function(r) {
              ...
              , M = function(t, e) {
                ...
                for (var p = 0, d = 0; d < e.length; d += 1)
                    p += e[d].totalCount;
                for (var m = new Array(p), T = 0, d = 0; o > d; d += 1)
                    for (var c = 0; c < e.length; c += 1)
                        d < u[c].length && (m[T] = u[c][d],
                        T += 1);
                for (var d = 0; a > d; d += 1)
                    for (var c = 0; c < e.length; c += 1)
                        d < f[c].length && (m[T] = f[c][d],
                        T += 1);
                return m
            }
              , b = function(r, t, e) {
                ...
                if (c.getLengthInBits() > 8 * d)
                    throw new Error("code length overflow. (" + c.getLengthInBits() + ">" + 8 * d + ")");
                for (c.getLengthInBits() + 4 <= 8 * d && c.put(0, 4); c.getLengthInBits() % 8 != 0; )
                    c.putBit(!1);
                for (; !(c.getLengthInBits() >= 8 * d) && (c.put(o, 8),
        ...
        var e = {
            ...
            var a = function(r) {
              ...
              , u = function(r) {
                ...
                for (d += 1; d < o.length; ) {
                    ...
                    d += 1,
                    i.contains(h + g) ? h += g : (s.write(i.indexOf(h), n),
          ...
          , g = function(r, t, e, n) {
            ...
            var u = l();
            o.write(u);
            for (var f = s(), c = u.toByteArray(), d = 0; d < c.length; d += 1)
                f.writeByte(c[d]);
            f.flush();
            var g = "";
            return g += "<img",
